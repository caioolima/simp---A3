...
function Modal({ show, onClose, details }) {
  ...
  // Verificar se o endereço é válido para exibir o mapa
  const isAddressValid =
    details.rua && details.bairro && details.cidade && details.estado && details.cep;
  ...
  return (
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        ...
        <p className={styles.pModal}><strong>CEP:</strong> {details.cep || "Não especificado."}</p>
        ...
        {/* Renderizar a imagem somente se URL estiver disponível */}
        {details.imagemUrl ? (
          <>
          ...
          <p className={styles.pModal}><strong>Imagem anexada:</strong> Não especificado.</p>
        )}

        {/* Renderizar o mapa somente se o endereço for válido */}
        {isAddressValid ? (
          <>
          ...
          <p className={styles.pModal}><strong>Localização:</strong> Não especificado.</p>
        )}
      </div>
    </div>
  );
